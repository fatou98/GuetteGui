...
class AdminController extends Controller
{
    ...
    /**
      * Lister New Commande
      *
      * @Route("modules/Commande/new", name="list of New Commande")
      */
    ...
    /**
      ...
      *
      * @Route("modules/Commande/approved", name="list of  Commande Approved")
      */
      public function ListOfCommandeApproved()
      {
        ...
        $commande= $em->getRepository(Commande::class)->findBy(['etat'=>1]);
          $vide= '';
                    ...
                    return $this->render('admin/modules/ListofApprovedCommande.html.twig', array(
                        'commande' => $commande));
                    }
      ...
      public function ListOfClient()
      {
        ...
        $Clients= $em->getRepository(Client::class)->findAll();
             ...
             if(!empty($Clients)){
                    ...
                    return $this->render('admin/modules/ListOfCustomers.html.twig', array(
                        'Client' => $Clients));
                    };
    }
